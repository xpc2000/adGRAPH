...
//////////////////////////////////////////////////////////////////////////////////////////
    ...
    __global__ void tricnt_thr_k(const ROW_T ner,
      ...
      std::cout<<BDIM<<endl;
      std::cout<<LOCLEN<<endl;
      std::cout<<tid<<endl;
      std::cout<<gridDim.x<<endl;
      std::cout<<ner<<endl;
      for(int i=0;i<sizeof(rows)/sizrof(rows[0]),i++): std::cout<<rows[i]<<" ";
      std::cout<<endl;
      for(int i=0;i<sizeof(roff)/sizrof(roff[0]),i++): std::cout<<roff[i]<<" ";
      std::cout<<endl;
      for(int i=0;i<sizeof(cols)/sizrof(cols[0]),i++): std::cout<<cols[i]<<" ";
      std::cout<<endl;
